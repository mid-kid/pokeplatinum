...
struct NNSiMcsFileIOWork {
    ...
    #define         NNS_McsSeekFile(pFile, distanceToMove, moveMethod, pNewFilePointer) ((void)((void)((void)((void)(pFile), (distanceToMove)), (moveMethod)), (pNewFilePointer)), NNS_MCS_FILEIO_ERROR_COMERROR)
