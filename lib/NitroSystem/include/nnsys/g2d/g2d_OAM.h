...
NNS_G2D_INLINE void NNS_G2dSetOamManagerSpriteZoffsetStep(NNSG2dOamManagerInstance * pMan, fx32 zStep) {
    ...
    NNS_G2D_WARNING(pMan->type == NNS_G2D_OAMTYPE_SOFTWAREEMULATION, "This function works only for the manager initialized as NNS_G2D_OAMTYPE_SOFTWAREEMULATION type ");
