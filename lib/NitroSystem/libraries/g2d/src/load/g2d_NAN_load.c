...

    {
        NNSG2dBinaryFileHeader * pBinFile = (NNSG2dBinaryFileHeader *)pNanrFile;
        {
            NNSG2dAnimBankDataBlock * pAnimBankBlk =
                (NNSG2dAnimBankDataBlock *)NNS_G2dFindBinaryBlock(pBinFile, NNS_G2D_BLKSIG_ANIMBANK);
...
BOOL NNS_G2dGetUnpackedAnimBank(void * pNanrFile, NNSG2dAnimBankData ** ppAnimBank) {
    ...
    NNS_G2D_ASSERTMSG(NNSi_G2dIsBinFileSignatureValid(pNanrFile, NNS_G2D_BINFILE_SIG_CELLANIM), "Input file signature is invalid for this method.");
    NNS_G2D_ASSERTMSG(NNSi_G2dIsBinFileVersionValid(pNanrFile, BIN_FILE_VERSION(NANR)), "Input file is obsolete. Please use the new g2dcvtr.exe.");
...
BOOL NNS_G2dGetUnpackedMCAnimBank(void * pNanrFile, NNSG2dAnimBankData ** ppAnimBank) {
    ...
    NNS_G2D_ASSERTMSG(NNSi_G2dIsBinFileSignatureValid(pNanrFile, NNS_G2D_BINFILE_SIG_MULTICELLANIM), "Input file signature is invalid for this method.");
    NNS_G2D_ASSERTMSG(NNSi_G2dIsBinFileVersionValid(pNanrFile, BIN_FILE_VERSION(NANR)), "Input file is obsolete. Please use the new g2dcvtr.exe.");
