...
BOOL NNS_G2dGetUnpackedScreenData(void * pNscrFile, NNSG2dScreenData ** ppScrData) {
    ...
    NNS_G2D_ASSERTMSG(NNS_G2dIsBinFileValid(pNscrFile, NNS_G2D_BINFILE_SIG_SCRDATA, BIN_FILE_VERSION(NSCR)), "Input file is obsolete. Please use the new g2dcvtr.exe.");

    {
        NNSG2dBinaryFileHeader * pBinFile = (NNSG2dBinaryFileHeader *)pNscrFile;

        {
            NNSG2dScreenDataBlock * pBinBlk = (NNSG2dScreenDataBlock *)NNS_G2dFindBinaryBlock(pBinFile, NNS_G2D_BINBLK_SIG_SCRDATA);
