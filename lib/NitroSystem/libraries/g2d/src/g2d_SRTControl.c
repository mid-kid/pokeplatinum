...
#define ASSERT_SRT_MODE(val)  NNS_G2D_ASSERTMSG((val) == NNS_G2D_SRTCONTROLTYPE_SRT, "You can use the function only if its NNSG2dSRTControlType is NNS_G2D_SRTCONTROLTYPE_SRT");
