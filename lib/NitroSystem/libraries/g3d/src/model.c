...
void NNS_G3dMdlSetMdlDiff(NNSG3dResMdl * pMdl, u32 matID, GXRgb col) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlDiff is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlAmb(NNSG3dResMdl * pMdl, u32 matID, GXRgb col) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlAmb is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlSpec(NNSG3dResMdl * pMdl, u32 matID, GXRgb col) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlSpec is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlEmi(NNSG3dResMdl * pMdl, u32 matID, GXRgb col) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlEmi is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlLightEnableFlag(NNSG3dResMdl * pMdl, u32 matID, int light) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlLightEnableFlag is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlPolygonMode(NNSG3dResMdl * pMdl, u32 matID, GXPolygonMode polyMode) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlPolygonMode is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlCullMode(NNSG3dResMdl * pMdl, u32 matID, GXCull cullMode) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlCullMode is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlPolygonID(NNSG3dResMdl * pMdl, u32 matID, int polygonID) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlPolygonID is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlAlpha(NNSG3dResMdl * pMdl, u32 matID, int alpha) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlAlpha is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlFogEnableFlag(NNSG3dResMdl * pMdl, u32 matID, BOOL flag) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlFogEnableFlag is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlDepthTestCond(NNSG3dResMdl * pMdl, u32 matID, BOOL flag) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlDepthTestCond is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdl1Dot(NNSG3dResMdl * pMdl, u32 matID, BOOL flag) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdl1Dot is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlFarClip(NNSG3dResMdl * pMdl, u32 matID, BOOL flag) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlFarClip is available only to standard(default) materials");
...
void NNS_G3dMdlSetMdlXLDepthUpdate(NNSG3dResMdl * pMdl, u32 matID, BOOL flag) {
    ...
    NNS_G3D_NULL_ASSERT(data);
    NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD, "NNS_G3dMdlSetMdlXLDepthUpdate is available only to standard(default) materials");
