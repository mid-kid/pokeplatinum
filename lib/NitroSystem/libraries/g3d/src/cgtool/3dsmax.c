...
#include <nnsys/g3d/gecom.h>
    ...
    static void texmtxCalc_flag_(MtxFx44 * m, const NNSG3dMatAnmResult * anm) {
        ...
        m->_30 = (fx32)(((fx64)ss_cos * p - (fx64)ss_sin * q) >> (FX32_SHIFT - 4)) + (anm->origWidth << (FX32_SHIFT - 1 + 4));
        m->_31 = (fx32)(((fx64)st_sin * p + (fx64)st_cos * q) >> (FX32_SHIFT - 4)) + (anm->origHeight << (FX32_SHIFT - 1 + 4));
    ...
    static void texmtxCalc_flagS_(MtxFx44 * m, const NNSG3dMatAnmResult * anm) {
        ...
        m->_30 = (fx32)(((fx64)anm->cosR * p - (fx64)anm->sinR * q) >> (FX32_SHIFT - 4)) + (anm->origWidth << (FX32_SHIFT - 1 + 4));
        m->_31 = (fx32)(((fx64)anm->sinR * p + (fx64)anm->cosR * q) >> (FX32_SHIFT - 4)) + (anm->origHeight << (FX32_SHIFT - 1 + 4));
    ...
    static void texmtxCalc_flagR_(MtxFx44 * m, const NNSG3dMatAnmResult * anm) {
        ...
        m->_30 = (fx32)(((fx64)anm->scaleS * p) >> (FX32_SHIFT - 4)) + (anm->origWidth << (FX32_SHIFT - 1 + 4));
        m->_31 = (fx32)(((fx64)anm->scaleT * q) >> (FX32_SHIFT - 4)) + (anm->origHeight << (FX32_SHIFT - 1 + 4));
        m->_10 = 0;
    }
