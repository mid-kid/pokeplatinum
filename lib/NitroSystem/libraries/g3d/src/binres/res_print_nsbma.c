...
#include <nnsys/g3d/binres/res_struct_accessor.h>
    ...
    static void printColData_(u32 info) {
    ...
    static void printAlphaData_(u32 info) {
        if (info & NNS_G3D_MATCANM_ELEM_CONST) {
    ...
    void NNS_G3dPrintMatColAnm(const NNSG3dResMatCAnm * pMatColAnm) {
        u16 j;
        tabPlus_();
    ...
    void NNS_G3dPrintMatColAnmSet(const NNSG3dResMatCAnmSet * pAnmSet) {
        u8 i;
    ...
    void NNS_G3dPrintNSBMA(const u8 * binFile) {
        u32 i;
