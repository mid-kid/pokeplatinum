...
void NNS_G3dGlbInit(void) {
    ...
    NNS_G3dGlb.prmMatColor0 = GX_PACK_DIFFAMB_PARAM(GX_RGB(16, 16, 16), GX_RGB(16, 16, 16), TRUE);
    NNS_G3dGlb.prmMatColor1 = GX_PACK_SPECEMI_PARAM(GX_RGB(16, 16, 16), GX_RGB(16, 16, 16), TRUE);

    NNS_G3dGlb.prmPolygonAttr = GX_PACK_POLYGONATTR_PARAM(0xf, GX_POLYGONMODE_MODULATE, GX_CULL_BACK, 0, 31, GX_POLYGON_ATTR_MISC_NONE);
...
void NNS_G3dGlbFlushVP(void) {
    ...
    NNS_G3dGeBufferOP_N(GX_PACK_OP(G3OP_MTX_MODE, G3OP_MTX_LOAD_4x4, G3OP_NOP, G3OP_NOP), (u32 *)&NNS_G3dGlb.mtxmode_proj, (sizeof(NNS_G3dGlb.mtxmode_proj) +
                                                                                                                            sizeof(NNS_G3dGlb.projMtx)) / 4);

    NNS_G3dGeBufferOP_N((G3OP_MTX_MULT_4x3 << 0), (u32 *)&NNS_G3dGlb.cameraMtx, sizeof(NNS_G3dGlb.cameraMtx) / 4);
...
void NNS_G3dGlbFlushWVP(void) {
    ...
    NNS_G3dGeBufferOP_N(GX_PACK_OP(G3OP_MTX_MULT_4x3, G3OP_MTX_SCALE, G3OP_NOP, G3OP_NOP), (u32 *)&NNS_G3dGlb.prmBaseRot, (sizeof(NNS_G3dGlb.prmBaseRot) +
                                                                                                                           sizeof(NNS_G3dGlb.prmBaseTrans) +
...
void NNS_G3dGlbPolygonAttr(int light, GXPolygonMode polyMode, GXCull cullMode, int polygonID, int alpha, int misc) {
    ...
    NNS_G3dGlb.prmPolygonAttr = GX_PACK_POLYGONATTR_PARAM(light, polyMode, cullMode, polygonID, alpha, misc);
}
...
const MtxFx43 * NNS_G3dGlbGetInvW(void) {
    if (!(NNS_G3dGlb.flag & NNS_G3D_GLB_FLAG_INVBASE_UPTODATE)) {
        ...
        MTX_ScaleApply43((MtxFx43 *)&NNS_G3dGlb.prmBaseRot, &tmp, NNS_G3dGlb.prmBaseScale.x, NNS_G3dGlb.prmBaseScale.y, NNS_G3dGlb.prmBaseScale.z);
...
static void calcSrtCameraMtx_(void) {
    ...
    MTX_Concat43((MtxFx43 *)&NNS_G3dGlb.prmBaseRot, &NNS_G3dGlb.cameraMtx, &NNS_G3dGlb.srtCameraMtx);
    MTX_ScaleApply43(&NNS_G3dGlb.srtCameraMtx, &NNS_G3dGlb.srtCameraMtx, NNS_G3dGlb.prmBaseScale.x, NNS_G3dGlb.prmBaseScale.y, NNS_G3dGlb.prmBaseScale.z);
    result = MTX_Inverse43(&NNS_G3dGlb.srtCameraMtx, &NNS_G3dGlb.invSrtCameraMtx);
    NNS_G3D_ASSERT(!result);
}
